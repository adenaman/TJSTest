...
exports.createDrawer = function(actualPage){
    ...
    var videoTest = createItem("Video Test", "images/salad.jpg",    
                            require('./videoTest.js'), actualPage);
    ...
    videoTest.set("layoutData", {top: [databaseTest, 20], left: 0, right: 0});
