...
function createPage() {
    ...
    var inputName1 = tabris.create("TextInput", {
      layoutData: {top: 10, left: "20%", right: "20%"},
      message: "Nombre"
    }).appendTo(scrollView);
    
    var inputName2 = tabris.create("TextInput", {
      layoutData: {top: [inputName1, 20], left: "20%", right: "20%"},
      message: "Apellidos"
    }).appendTo(scrollView);

    var picker = tabris.create("Picker", {
        layoutData: {top: [inputName2, 20], left: "20%", right: "20%"},
    ...
    var compositeMultilineBorder = tabris.create("Composite", {
        layoutData: {top: [picker, 20], left: "20%", right: "20%"},
        background : "#c3c3c3"
    }).appendTo(scrollView);
